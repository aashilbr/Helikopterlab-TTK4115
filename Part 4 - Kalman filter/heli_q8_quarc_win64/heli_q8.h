...
typedef struct {
  ...
  real_T F[2];                         /* '<S1>/F' */
  real_T gamma;                        /* '<S1>/gamma' */
  real_T zeta;                         /* '<S1>/zeta' */
  real_T Sum_e[2];                     /* '<S1>/Sum' */
  real_T Sum1_n;                       /* '<S1>/Sum1' */
  real_T Sum2;                         /* '<S1>/Sum2' */
  real_T Frontgain;                    /* '<S2>/Front gain' */
  real_T Backgain;                     /* '<S2>/Back gain' */
  ...
  real_T A_d[36];                      /* '<S8>/A_d' */
  real_T B_d[12];                      /* '<S8>/B_d' */
  real_T Q_d[36];                      /* '<S8>/Q_d' */
  real_T K_ei;                         /* '<S12>/K_ei' */
  real_T xk_next[6];                   /* '<S8>/Prediction_step' */
  real_T P_pred_next[36];              /* '<S8>/Prediction_step' */
  real_T xk_est[6];                    /* '<S8>/Correction_step' */
  real_T P_est[36];                    /* '<S8>/Correction_step' */
  real_T euler_rates[3];               /* '<S3>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  uint8_T StreamCall1_o2;              /* '<S6>/Stream Call1' */
} B_heli_q8_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput[10];     /* '<S6>/Memory' */
  ...
  t_stream StreamCall1_Stream;         /* '<S6>/Stream Call1' */
  ...
  struct {
    void *LoggedData;
  } Scope1_PWORK_j;                    /* '<S1>/Scope1' */

  struct {
    void *LoggedData;
  } elevationrate_PWORK;               /* '<S1>/elevation rate' */
  ...
  uint8_T StreamCall1_State;           /* '<S6>/Stream Call1' */
} DW_heli_q8_T;
...
typedef struct {
  ...
  real_T gamma_CSTATE;                 /* '<S1>/gamma' */
  real_T zeta_CSTATE;                  /* '<S1>/zeta' */
...
typedef struct {
  ...
  boolean_T gamma_CSTATE;              /* '<S1>/gamma' */
  boolean_T zeta_CSTATE;               /* '<S1>/zeta' */
...
struct P_heli_q8_T_ {
  ...
  real_T Constant_Value;               /* Expression: 0
                                        ...
                                        */
  real_T Constant4_Value;              /* Expression: -0.09
                                        * Referenced by: '<S3>/Constant4'
                                        */
  real_T Constant_Value_l;             /* Expression: 0
                                        * Referenced by: '<S6>/Constant'
                                        */
  real_T Constant1_Value_a;            /* Expression: 65
  ...
  real_T Switch1_Threshold;            /* Expression: 0
                                        ...
                                        */
  real_T Constant2_Value;              /* Expression: 0.018
  ...
  real_T Constant5_Value;              /* Expression: 0.01
                                        ...
                                        */
  real_T Constant6_Value;              /* Expression: 0.004
 ...
 * '<S3>'   : 'heli_q8/Conversion from IMU'
 * '<S4>'   : 'heli_q8/Elevation controller'
 * '<S5>'   : 'heli_q8/Heli 3D'
 * '<S6>'   : 'heli_q8/IMU'
 * '<S7>'   : 'heli_q8/Joystick'
 * '<S8>'   : 'heli_q8/Kalman filter'
 * '<S9>'   : 'heli_q8/Pitch controller'
 * '<S10>'  : 'heli_q8/Conversion from IMU/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'heli_q8/Conversion from IMU/Transformation'
 * '<S12>'  : 'heli_q8/Elevation controller/Elevation controller'
 * '<S13>'  : 'heli_q8/Kalman filter/Correction_step'
 * '<S14>'  : 'heli_q8/Kalman filter/Prediction_step'
 */
