 ...
 *
 * '<Root>' : 'heli_q8_2'
 * '<S1>'   : 'heli_q8_2/Controller'
 * '<S2>'   : 'heli_q8_2/Conversion'
 * '<S3>'   : 'heli_q8_2/Elevation controller'
 * '<S4>'   : 'heli_q8_2/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S5>'   : 'heli_q8_2/Heli 3D'
 * '<S6>'   : 'heli_q8_2/IMU'
 * '<S7>'   : 'heli_q8_2/Joystick'
 * '<S8>'   : 'heli_q8_2/Pitch controller'
 * '<S9>'   : 'heli_q8_2/Transformation'
 * '<S10>'  : 'heli_q8_2/Elevation controller/Elevation controller'
 */
