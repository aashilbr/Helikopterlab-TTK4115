...
typedef struct {
  real_T Integrator_CSTATE[5];         /* '<S7>/Integrator' */
...
/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[5];      /* '<S7>/Integrator' */
...
#define rtY                            heli_q8_Y
#define ExternalOutputs                ExtY_heli_q8_T
...
struct P_heli_q8_T_ {
  real_T A_e[25];                      /* Variable: A_e
                                        * Referenced by: '<S7>/Gain3'
                                        */
  real_T B_e[10];                      /* Variable: B_e
  ...
  real_T F[4];                         /* Variable: F
                                        * Referenced by: '<S1>/F'
                                        */
  real_T IMU_offset[5];                /* Variable: IMU_offset
  ...
  real_T Constant_Value_j;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_p;            /* Expression: 65
...
/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_heli_q8_T heli_q8_Y;
 ...
 * '<S3>'   : 'heli_q8/Heli 3D'
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/IMU conversion'
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/observator  '
 * '<S8>'   : 'heli_q8/IMU conversion/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S9>'   : 'heli_q8/IMU conversion/Transformation'
 */
